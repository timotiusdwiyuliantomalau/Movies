...
<template>
  <div class="relative">
    <div v-if="flashSuccess.message.length>0"
      class="flex items-center p-2  text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 z-50 top-5 -translate-x-1/2 left-1/2 fixed"
      role="alert">
