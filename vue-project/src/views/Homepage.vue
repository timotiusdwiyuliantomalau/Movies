  ...
  <div>
      <main class="w-full min-h-screen bg-custom-linear items-center flex flex-col justify-center" style="">
        ...
        <form class="flex rounded-full overflow-hidden">
          <input typehover:opacity-70 cursor-pointer ="search" class="pl-3" placeholder="Search for a movie.." name="search" id="">
          <input typehover:opacity-70 cursor-pointer ="submit" value="Cari" class="bg-black p-1 cursor-pointer text-white " />
        </form>
      </main>
